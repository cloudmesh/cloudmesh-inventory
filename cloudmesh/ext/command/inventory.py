...
from cloudmesh.inventory.data import inventory
import hostlist
    ...
    def do_inventory(self, args, arguments):
        ...
        ::
          ...
          Examples:
            ...
            inventory add x[0-3] --service=openstack
            ...
            inventory x[3-4] set temperature to 32

                sets for the resources x3, x4 the value of the
                temperature to 32

            inventory x[7-8] set ip 128.0.0.[0-1]

                sets the value of x7 to 128.0.0.0
                sets the value of x8 to 128.0.0.1

            inventory clone x[5-6] from x3
